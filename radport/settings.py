"""
Django settings for radport project.
...
# PACS_PRIVATE_URL = "https://pacs.radport.net"  # loopback, no TLS overhead
...
SECRET_KEY = 'django-insecure-*othplrf^@z$5z)1c26fjcaogymoo06d$^1a$g8(y$ar7kvs^+'
...
WSGI_APPLICATION = 'radport.wsgi.application'
